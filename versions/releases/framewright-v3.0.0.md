...
10. Generation-Unit Feasibility Gate
...
Board titles and metadata may remain typographic. Panel interiors must not encode final-video color, lighting, texture, atmosphere, or finish.
...
```text
[MODE: ...]
Create a production storyboard sheet. Treat every panel as a monochrome line drawing
for shot planning, not as a final cinematic image.
```
